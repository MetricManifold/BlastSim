...
#define UPDATE(IND, s) \
	LOOP rho[i + D][j + D] = drho[i][j] + s * k[IND][i][j].rho; \
	LOOP u[i + D][j + D] = (du[i][j] * drho[i][j] + s * k[IND][i][j].rhou) / rho[i + D][j + D]; \
	LOOP v[i + D][j + D] = (dv[i][j] * drho[i][j] + s * k[IND][i][j].rhov) / rho[i + D][j + D]; \
	LOOP e[i + D][j + D] = (de[i][j] * drho[i][j] + s * k[IND][i][j].rhoe) / rho[i + D][j + D];
