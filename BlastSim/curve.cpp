	...
	double a(double e, double rho)
	{
		...
		else if (Y < -4.5)
		{
			if (Z < 1.50)
			{
				...
				a1 = -6.13514e-1 + (+4.75120e-5 * 2 - 2.19921e-1 * 3 * Z) * Z;
			...
			else if (Z < 2.20)
			{
				...
				a1 = +2.46299e1 + (+2.29618e-3 * 2 + 1.62903 * 3 * Z) * Z;
			...
			else if (Z < 3.05)
			{
				...
				a1 = -5.32238e-1 + (-1.01359e-4 * 2 + 3.66035e-2 * 3 * Z) * Z;
			...
			else if (Z < 3.40)
			{
				...
				a1 = +0.22591e2 + (+0.23966e-2 * 2 + .878 * 3 * Z) * Z;
			...
			else
			{
				...
				a1 = +4.56439e1 + (+2.43161e-3 * 2 + 1.22998 * 3 * Z) * Z;
		...
		else if (Y < -0.5)
		{
			if (Z < 1.50)
			{
				...
				a1 = +1.42545e-2 + (+6.52912e-4 * 2 - 9.78720e-2 * 3 * Z) * Z;
			...
			else if (Z < 2.22)
			{
				...
				a1 = +5.02307 + (+5.23524e-3 * 2 + 6.51564e-1 * 3 * Z) * Z;
			...
			else if (Z < 2.95)
			{
				...
				a1 = +4.90497 + (+1.74209e-3 * 2 + 3.33658e-1 * 3 * Z) * Z;
			...
			else
			{
				...
				a1 = +1.7835e1 + (+3.9774e-3 * 2 + 6.60432e-1 * 3 * Z) * Z;
		...
		else
		{
			if (Z < 1.70)
			{
				...
				a1 = +1.11418e-1 + (-2.00286e-3 * 2 + 3.0221e-3 * 3 * Z) * Z;
			...
			else if (Z < 2.35)
			{
				...
				a1 = +2.85574 + (+4.23659e-3 * 2 + 4.08518e-1 * 3 * Z) * Z;
			...
			else
			{
				...
				a1 = +4.23104 + (+3.85707e-3 * 2 + 2.95882e-1 * 3 * Z) * Z;
